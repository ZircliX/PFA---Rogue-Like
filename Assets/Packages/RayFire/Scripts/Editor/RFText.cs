...
namespace RayFireEditor
{
    ...
    public static class TextAct
    {
        ...
        public static readonly GUIContent gui_speed             = new GUIContent ("Speed",              "Objects wil be activated if Activator speed (m/s) is higher than this value. Disabled when 0.");
