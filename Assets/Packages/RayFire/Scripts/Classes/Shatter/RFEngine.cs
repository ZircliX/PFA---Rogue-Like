...
namespace RayFire
{
    public class RFEngine
    {
        ...
        public Matrix4x4[]        centroidScaleMat = null;
        public Matrix4x4[]        flatExtraMat     = null;
        ...
        static void SetupFragmentation(RFEngine engine, Transform tm, bool separate, bool precap, SliceType sliceType, Vector3 axisScale, Transform cutAABB, bool aabbSeparate)
        {
            ...
            // Get min and max
            Utils.Mesh.Transform (engine.fragMeshes, engine.normalMat, out Vector3 aabbMin, out Vector3 aabbMax);
            ...
            engine.sliceData.SetAABB (engine.fragMeshes, axisScale, aabbCentroid, aabbSize, cutAABBMat, aabbSeparate);
        }
        ...
        static void ProcessFragmentation(RFEngine engine, RFSurface material, FragType fragType, bool combine, int element, int clusterCount, int layers, int faceFlt, bool outCap, bool smooth) 
        {
            ...
            if (fragType != FragType.Decompose)
                engine.fragMeshes = Utils.Mesh.Slice (engine.sliceData, combine, engine.openEdgeFlags, element * 0.01f, faceFlt, clusterCount, layers);
