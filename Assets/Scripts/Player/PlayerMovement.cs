...
namespace RogueLike.Player
{
    ...
    [Header("Movement States")] [SerializeField]
    private MovementStateBehavior[] movementStates;

    private int currentStateIndex;

    [Header("Ground")] [SerializeField] private float groundCheckDistance = 0.1f;
    [SerializeField] private float groundCheckMaxAngle = 50;
    [field: SerializeField] public LayerMask GroundLayer { get; private set; }
    public float DistanceFromGround { get; private set; }

    [Header("Walls")] [SerializeField] private int wallCastSample = 15;
    ...
    [Header("Power Up Properties")] private Dictionary<string, IVisitor> unlockedPowerUps;
    ...
    [Header("Gravity")] [SerializeField] private float gravityScale = 1;
    [SerializeField] private float gravityAlignSpeed = 5;

    [Header("Coyote")] [SerializeField] private int coyoteTime = 10;

    [field: Header("Height")]
    [field: SerializeField]
    public float BaseCapsuleHeight { get; private set; } = 2;
    ...
    {
        VisitableReferenceManager.Instance.RegisterComponent(GameMetrics.Global.PlayerMovementVisitableType, this);
    }
